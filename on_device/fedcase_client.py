...
class Trainer:
    ...
    def client_data_sampling(self):
        ...
        self.current_client_instance.train_set_len = len(self.current_client_instance.selected_samples_index)
    def load_dataset(self):
        if self.current_client_instance.participation_times > 2:
            self.client_data_sampling()
            self.trainloader.sampler.set_index(self.current_client_instance.selected_samples_index)
        else:
