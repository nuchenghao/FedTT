...
class FedNovaTrainer(FedAvgTrainer):
    ...
    def full_set(self):
        ...
        self.current_client.coeff = (tau - self.rho * (1 - pow(self.rho, tau)) / (1 - self.rho)) / (1 - self.rho)
        self.current_client.norm_grad = copy.deepcopy(self.current_client.model_dict)
